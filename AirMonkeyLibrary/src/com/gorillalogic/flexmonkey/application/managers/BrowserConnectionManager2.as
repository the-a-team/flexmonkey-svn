package com.gorillalogic.flexmonkey.application.managers
{
	...
	public class BrowserConnectionManager2 extends MonkeyConnection
	{
		
		public var mateDispatcher : IEventDispatcher;			

		static private var _browserConnection:BrowserConnectionManager2;
		static public function get browserConnection():BrowserConnectionManager2{
			return _browserConnection;
		}
		static public function setClassReference(b:BrowserConnectionManager2):void{
			_browserConnection = b;		
		}	
		public function setSingleton():void{
			BrowserConnectionManager2.setClassReference(this);
		}
		...
		public function BrowserConnectionManager2()
		{
			super();
