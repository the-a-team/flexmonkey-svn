...
//obj.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,monkeyFocusPropagationHandler,false,EventPriority.DEFAULT+100000,true);
...
obj.addEventListener(MouseEvent.MOUSE_DOWN,monkeyMouseDownHandler,false,EventPriority.DEFAULT+100000,true);
